<div class="flex flex-col transition-all h-full overflow-hidden">
    ...
    <main class="overflow-y-scroll overflow-hidden grow  h-full relative " style="contain:content">
        ...
        <ul class="p-2 grid w-full spacey-y-2">
            <li class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 bg-gray-100/70 }}">
                <a href="#" class="shrink-0">
                    <x-avatar src="{{$data['image_url']}}"/>
                </a>
